...
def system_logic_2hard(v, options, xLoc, oLoc, i, locations):
...
def system_logic_2medium(v, options, xLoc, oLoc, i, locations):
	#logics for finding the right position of 'o' for wining if possible
	if v[1]==v[2]=="o" and v[3] not in options :
		oLoc = 3
	elif v[1]==v[3]=="o" and v[2] not in options :
...
def system_logic_1hard(v, options, xLoc, oLoc, i, locations):
	#logics for finding the right position of 'o' for wining if possible
	if v[1]==v[2]=="o" and v[3] not in options :
		oLoc = 3
	elif v[1]==v[3]=="o" and v[2] not in options :
...
def system_logic_1medium(v, options, xLoc, oLoc, i, locations):
	#logics for finding the right position of 'o' for wining if possible
	if v[1]==v[2]=="o" and v[3] not in options :
		oLoc = 3
	elif v[1]==v[3]=="o" and v[2] not in options :
